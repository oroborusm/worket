...
class TipoRolesControllerTest < ActionController::TestCase
  ...
  test "should get index" do
    ...
    assert_not_nil assigns(:tipo_roles)
  end
  ...
  test "should create tipo_rol" do
    assert_difference('TipoRol.count') do
      post :create, tipo_rol: { nombre: @tipo_rol.nombre }
    end
  ...
  test "should update tipo_rol" do
    patch :update, id: @tipo_rol, tipo_rol: { nombre: @tipo_rol.nombre }
    assert_redirected_to tipo_rol_path(assigns(:tipo_rol))
  end
  ...
  test "should destroy tipo_rol" do
    ...
    assert_redirected_to tipo_roles_path
  end
end

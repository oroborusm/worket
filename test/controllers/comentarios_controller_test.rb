...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { texto: @comentario.texto, usuario_id: @comentario.usuario_id, usuario_worket_id: @comentario.usuario_worket_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { texto: @comentario.texto, usuario_id: @comentario.usuario_id, usuario_worket_id: @comentario.usuario_worket_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end

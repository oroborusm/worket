...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { precio: @servicio.precio, resumen: @servicio.resumen, titulo: @servicio.titulo, usuario_worket_id: @servicio.usuario_worket_id }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { precio: @servicio.precio, resumen: @servicio.resumen, titulo: @servicio.titulo, usuario_worket_id: @servicio.usuario_worket_id }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
